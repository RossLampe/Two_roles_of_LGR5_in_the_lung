...
#
################################################################################
res_AvsB <- read.csv(here("Data", "rlogNorm__D111_AdultPig_GFPpos_vs_GFPneg_Annotated11.1.105.csv"), header = TRUE)
...
#Filter by padj.cutoff
res_signif_AvsB <- df_res_AvsB_shaped %>%
    mutate(threshold_OE =  padj < padj.cutoff)
